...
function DerivePublicAddresses(phrase, word = "(no missing word)")
 {
     ...
     var addressEth = DerivePublicAddress(pathEth)
        ...
        /*
         ...
         .then(function(d) {x = d.total_received; console.log(x); });
         */
        var html = '';
         html = '<tr><td>' + word +
 ...
 /*$.get('https://api.ethplorer.io/getAddressInfo/' + addressEth +'?apiKey=freekey')
 .then(function(d) {console.log(d);console.log(d.countTxs);});
 */
 }
